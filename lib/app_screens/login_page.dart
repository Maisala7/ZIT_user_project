          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Align(
                ...
                child: Text(language==1?"Login":"تسجيل الدخول", style: TextStyle(color: Colors.white, fontSize: 40),)),
      ),
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                      ...
                      children: <Widget>[
                       ...
                       Form(
                        key: _log_informkey,
                         ...
                         color: iconcolor,),
                          ...
                          validator: (value) {
                                        if (value!.isEmpty ) {
                                          return language==1?'This field is required':"هذا الحقل مطلوب";
                                        }
                                       else if (value!=usernameController.text ) {
                                          return language==1?'user name is not correct':" اسم المستخدم غير صحيح";
                                        }
                                        return null;
                                      },
                                         ),
                       TextFormField(
                         ...
                         controller: loginpasswordController,
                          decoration:  InputDecoration(
                         hintText:language==1?"password":"  كلمة السر",
                         hintStyle: const TextStyle(
                           color: iconcolor,
                           fontWeight: FontWeight.bold
                         ),
                         ...
                         color: iconcolor,),
                           ...
                           validator: (value) {
                                        if (value!.isEmpty ) {
                                          ...
                                          return language==1?' password is not correct':" كلمة السر  غير صحيحه";
                                        }
                                        return null;
                                      },
                                         ),
                       ...
                       GestureDetector(
                        ...
                        child: Text(language==1?" Creat Acount":"  انشاء حساب",
                        textAlign: TextAlign.center,
                         style: TextStyle(color: Color.fromARGB(255, 78, 68, 68),fontSize: 20),)),
                          SizedBox(height: 20,),
                     Container(
                          height: 50,
                          ...
                          child: Center(
                            child: GestureDetector(
                              ...
                              child: Text(language==1?"Login":"دخول", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)),
                          ),
                        ),
                        SizedBox(height: 50,),
