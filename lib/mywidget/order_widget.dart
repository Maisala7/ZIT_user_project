...
class orderWidget extends StatelessWidget {
  orderWidget(
    ...
    required this.ordersImages,
  });

  final int language;
  final String Date;
  final String orderState;
  final List ordersImages;
    ...
    return Column(
      children: [
        Container(
          ...
          child: language == 1
              ? Row(
                  children: [
                    Text(
                      language == 1 ? "order date:" : ":تاريخ الطلبيه",
                      style: TextStyle(
                        fontSize: 18,
        ...
        SingleChildScrollView(
          ...
          child: Row(
              children: List.generate(ordersImages.length, (index) {
            return orderImagewidget(image: ordersImages[index]['Image']);
          })
              //  [
